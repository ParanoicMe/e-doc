...
public class SMDocBuilderImpl implements SMDocBuilder {
    ...
    @Override
    public void fillPostPackage(String name) {
        pp.setName(name);
        pp.setPostObjectWI(po);
    }

    @Override
    public void fillPostObject(String description, String action) {
    ...
    @Override
    public void fillCommonBases(String baseDocType, String orderId) {
    ...
    @Override
    public void fillSMDocBlobFile(String fileName, String base64) {
    ...
    @Override
    public void fillDocProps(BLRWBL b) {
    ...
    @Override
    public void fillSMDocument(BLRWBL b, String bornIn, String docState, String opCode, String priceRoundMode) {
        sd.setId(docId);
    ...
    @Override
    public void fillSMSpec(List<LineItem> list, String taxId) {
    ...
    @Override
    public void fillWayBillsIn(BLRWBL b) {
        swb.setId(docId);
